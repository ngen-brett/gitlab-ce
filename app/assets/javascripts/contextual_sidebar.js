...
export default class ContextualSidebar {
  ...
  constructor() {
    ...
    this.collapsedClass = 'sidebar-collapsed';
  }

  toggle(shouldCollapse = !this.$sidebar.hasClass(this.collapsedClass), saveCookie) {
    const isMobile = bp.is('xs', 'sm');

    this.$sidebar.toggleClass(this.collapsedClass, shouldCollapse);
  ...
  retoggle() {
    this.toggle(this.$sidebar.hasClass(this.collapsedClass));
  }
