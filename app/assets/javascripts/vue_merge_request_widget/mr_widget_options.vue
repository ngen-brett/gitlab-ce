...
import WhenPipelineSucceedsState from './components/states/mr_widget_when_pipeline_succeeds.vue';
...
export default {
  ...
  components: {
    ...
    'mr-widget-when-pipeline-succeeds': WhenPipelineSucceedsState,
