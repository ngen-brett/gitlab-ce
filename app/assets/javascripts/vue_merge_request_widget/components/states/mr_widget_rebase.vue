...
<template>
  ...
  js-toggle-container accept-action media space-children"
          >
            ...
            <span v-if="!rebasingError" class="bold">{{ __("Fast-forward merge is not possible. Rebase the source branch onto the target branch or merge target branch into source branch to allow this merge request to be merged.") }}</span>
