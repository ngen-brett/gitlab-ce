...
export default class Wikis {
  constructor() {
    ...
    this.isNewWikiPage = Boolean(document.querySelector('form.wiki-form.new-wiki-page'));
    ...
    this.commitMessageI18n = this.isNewWikiPage ? s__('WikiPageCreate|Create %{page_title}') : s__('WikiPageEdit|Update %{page_title}');
  ...
  setWikiCommitMessage(rawTitle) {
    ...
    const newCommitMessage = sprintf(this.commitMessageI18n, { page_title: title });
