...
module Clusters
  class CreateService
    ...
    def execute(access_token: nil)
      ...
      cluster_params = params.merge(global_params, clusterable_params)
    ...
    def global_params
      { user: current_user, namespace_per_environment: Feature.enabled?(:kubernetes_namespace_per_environment) }
    end
