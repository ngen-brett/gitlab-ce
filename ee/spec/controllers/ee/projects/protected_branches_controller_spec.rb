...
describe Projects::ProtectedBranchesController do
  ...
  shared_examples "after creating a new protected branch, set COAR to" do |boolean|
    it "creates the protected branch rule and sets COAR to #{boolean}" do
      expect do
  ...
  describe "POST #create" do
    ...
    context "when code_owner_approval_required is 'false'" do
      ...
      it_behaves_like "after creating a new protected branch, set COAR to", false
    end
    ...
    context "when code_owner_approval_required is 'true'" do
      ...
      context "when the feature is enabled" do
        ...
        it_behaves_like "after creating a new protected branch, set COAR to", true
      end
