...
| `POSTGRES_VERSION`           | The PostgreSQL version; defaults to `9.6.2`. This version number corresponds to an image tag for [the Docker postgres official image](https://hub.docker.com/_/postgres). |
