...
```bash
curl -s --header "PRIVATE-TOKEN: u-xsxBZdpkwyTDxCq95x" "https://gitlab.example.com/api/v4/projects/1/repository/commits/da738facbc19eb2fc2cef57c49be0e6038570352/signature"
```
...
```json
{
  "project_id": 1,
  "gpg_key_id": 1,
  "commit_sha": "da738facbc19eb2fc2cef57c49be0e6038570352",
