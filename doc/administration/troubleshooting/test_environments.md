...
This is a collection of information regarding testing environments collected by the
...
for how to run GitLab with `docker-machine`. When spinning this up in an instance running
docker-machine, ensure you change a few things:
...
The following will also need to go in your `/etc/gitlab/gitlab.rb`. See [our docs](https://docs.gitlab.com/ee/integration/saml.html)
...
See [our docs](https://docs.gitlab.com/ee/administration/integration/plantuml.html#docker)
