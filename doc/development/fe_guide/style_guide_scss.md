...
### Utility Classes
As part of the effort for [cleaning up our CSS and move our components into GitLab-UI](https://gitlab.com/groups/gitlab-org/-/epics/950)
lead by the [GitLab UI WG](https://gitlab.com/gitlab-com/www-gitlab-com/merge_requests/20623) we prefer the use of utility classes over adding new CSS.
