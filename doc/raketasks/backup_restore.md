...
NOTE: **Note:** Since file system performance may affect Gitlab's overall performance, we do not recommend using EFS for storage. You review [our documentation](https://docs.gitlab.com/ee/administration/high_availability/nfs.html#avoid-using-awss-elastic-file-system-efs) for more details.
