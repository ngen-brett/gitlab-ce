  ...
  describe '.call' do
    ...
    context 'with deployment platform' do
      ...
      context 'with group cluster' do
        ...
        let!(:k8s_ns) { create(:cluster_kubernetes_namespace, cluster: cluster, project: project, environment_slug: slug) }
        let!(:k8s_ns2) { create(:cluster_kubernetes_namespace, cluster: cluster, project: project2, environment_slug: slug) }
