...
describe Gitlab::Ci::Ansi2html do
  ...
  it "replaces newlines with line break tags" do
    expect(convert_html("\n")).to eq('<span class=""></span><span class=""><br/></span><span class=""></span>')
  end
  ...
  describe "incremental update" do
    ...
    context 'with new line' do
      ...
      let(:text) { "\nWorld" }
      let(:html) { "<span class=\"\"></span><span class=\"\"><br/></span><span class=\"\">World</span>" }
  ...
  context "with section markers" do
    ...
    shared_examples 'a legit section' do
      ...
      it 'prints light red' do
        ...
        line_break = %{<span class="section js-section-header js-s-#{class_name(section_name)}"></span><span class="js-s-#{class_name(section_name)}"><br/></span>}
