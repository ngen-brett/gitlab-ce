...
describe KubernetesService, :use_clean_rails_memory_store_caching do
  ...
  describe '#namespace_for' do
    subject { service.namespace_for(project) }
  ...
  describe '#predefined_variable' do
    ...
    context 'no namespace provided' do
      let(:namespace) { subject.namespace_for(project) }
  ...
  describe '#terminals' do
    ...
    context 'with valid pods' do
      let(:pod) { kube_pod(environment_slug: environment.slug, namespace: service.namespace_for(project), project_slug: project.full_path_slug) }
  ...
  describe '#calculate_reactive_cache' do
    ...
    let(:namespace) { service.namespace_for(project) }
