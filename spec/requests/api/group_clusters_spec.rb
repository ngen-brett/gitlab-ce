...
describe API::GroupClusters do
  ...
  describe 'GET /groups/:id/clusters' do
    ...
    context 'non-authorized user' do
      it 'responds with 404' do
        get api("/groups/#{group.id}/clusters", non_member)
  ...
  describe 'GET /groups/:id/clusters/:cluster_id' do
    ...
    context 'non-authorized user' do
      it 'responds with 404' do
        get api("/groups/#{group.id}/clusters/#{cluster_id}", non_member)
  ...
  describe 'POST /groups/:id/clusters/user' do
    ...
    context 'non-authorized user' do
      it 'responds with 404' do
        post api("/groups/#{group.id}/clusters/user", non_member), params: cluster_params
  ...
  describe 'PUT /groups/:id/clusters/:cluster_id' do
    ...
    context 'non-authorized user' do
      it 'responds with 404' do
        put api("/groups/#{group.id}/clusters/#{cluster.id}", non_member), params: update_params
  ...
  describe 'DELETE /groups/:id/clusters/:cluster_id' do
    ...
    context 'non-authorized user' do
      it 'responds with 404' do
        delete api("/groups/#{group.id}/clusters/#{cluster.id}", non_member), params: cluster_params
