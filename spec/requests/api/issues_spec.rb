  ...
  describe "GET /groups/:id/issues" do
    ...
    context 'when group has subgroups', :nested_groups do
      ...
      it 'also returns subgroups projects issues' do
        ...
        expect_paginated_array_response([issue_2.id, issue_1.id, group_issue.id, group_confidential_issue.id, group_closed_issue.id])
      end
    end
    ...
    context 'when user is unauthenticated' do
      it 'lists all issues in public projects' do
        ...
        expect_paginated_array_response([group_issue.id, group_closed_issue.id])
      end
    end
    ...
    context 'when user is a group member' do
      ...
      it 'returns group confidential issues for author' do
        ...
        expect_paginated_array_response([group_issue.id, group_confidential_issue.id])
      end
      ...
      it 'returns an array of group issues with no label' do
        ...
        expect_paginated_array_response([group_confidential_issue.id, group_closed_issue.id])
      end
