...
describe API::Internal::Pages do
  describe "GET /internal/pages" do
    def query_host(host)
      get api("/internal/pages"), params: { host: host }
    end
    ...
    context 'custom domain' do
      it 'responds with the correct domain configuration' do
        ...
        expect(response).to match_response_schema('internal/pages_domain')
    ...
    context 'namespaced domain' do
      ...
      context 'regular project' do
        it 'responds with the correct domain configuration' do
          ...
          expect(response).to have_gitlab_http_status(200)
          expect(response).to match_response_schema('internal/namespace_domain')
