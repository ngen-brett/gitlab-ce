...
describe MergeRequests::MergeToRefService do
  ...
  describe '#execute' do
    ...
    describe 'cascading merge refs' do
      ...
      shared_examples_for 'MergeService for cascading ref' do
        it 'generates merge commit with the specific ref' do
          repository = project.repository
      ...
      context 'when first merge happens' do
        ...
        context 'when second merge happens' do
          let(:merge_request) { create(:merge_request, source_project: project, source_branch: 'improve/awesome', target_project: project, target_branch: 'master') }
