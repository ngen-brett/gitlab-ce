...
describe 'Database schema' do
  ...
  IGNORED_FK_COLUMNS = {
    ...
    emails: %w[user_id],
    events: %w[target_id],
    epics: %w[updated_by_id last_edited_by_id start_date_sourcing_milestone_id due_date_sourcing_milestone_id start_date_sourcing_epic_id end_date_sourcing_epic_id],
