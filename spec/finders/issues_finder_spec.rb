  ...
  describe '#execute' do
    ...
    context 'scope: all' do
      ...
      context 'filtering by closed_at' do
        let!(:closed_issue1) { create(:issue, author: user, assignees: [user], project: project1, state: :closed, closed_at: 1.week.ago) }
        let!(:closed_issue2) { create(:issue, author: user, assignees: [user], project: project2, state: :closed, closed_at: 1.week.from_now) }
        let!(:closed_issue3) { create(:issue, author: user2, assignees: [user2], project: project2, state: :closed, closed_at: 2.weeks.from_now) }
