...
shared_examples 'sends notification only to 10, most recently active group owners' do
  let(:owners) { create_list(:user, 12, :with_signins) }
  ...
  it 'sends notification only to 10, most recently active group owners' do
...
shared_examples 'sends notification only to 10, most recently active project maintainers' do
  let(:maintainers) { create_list(:user, 12, :with_signins) }
  ...
  it 'sends notification only to 10, most recently active project maintainers' do
