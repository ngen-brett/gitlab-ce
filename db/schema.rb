...
ActiveRecord::Schema.define(version: 20190412155659) do
  ...
  create_table "merge_request_blocks", force: :cascade do |t|
    ...
    t.index ["blocking_merge_request_id"], name: "index_merge_request_blocks_on_blocking_merge_request_id", using: :btree
  end
