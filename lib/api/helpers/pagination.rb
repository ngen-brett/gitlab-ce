    ...
    module Pagination
      ...
      class Base
        ...
        def page_href(next_page_params = {})
          ...
          request_uri.host = Gitlab.config.gitlab.host
          request_uri.port = nil

          request_params = params.merge(**next_page_params, per_page: per_page)
      ...
      class KeysetPaginationInfo < Base
      ...
      class DefaultPaginationStrategy < Base
        ...
        def pagination_links(paginated_data)
          ...
          unless data_without_counts?(paginated_data)
            links << %(<#{page_href(page: total_pages(paginated_data))}>; rel="last")
          end
