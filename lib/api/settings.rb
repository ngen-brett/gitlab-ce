...
module API
  class Settings < Grape::API
    ...
    params do
      ...
      optional :default_branch_protection, type: Integer, values: [Gitlab::Access::PROTECTION_NONE,
                                                                   Gitlab::Access::PROTECTION_DEV_CAN_PUSH,
                                                                   Gitlab::Access::PROTECTION_FULL,
                                                                   Gitlab::Access::PROTECTION_DEV_CAN_MERGE],
                                           desc: 'Determine if developers can push to master'
