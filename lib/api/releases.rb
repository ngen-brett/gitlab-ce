  ...
  class Releases < Grape::API
    ...
    resource :projects, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
      ...
      get ':id/releases' do
        ...
        present paginate(releases), with: Entities::Release, except: sensitive_repository_info
      end
      ...
      get ':id/releases/:tag_name', requirements: RELEASE_ENDPOINT_REQUIREMETS do
        ...
        present release, with: Entities::Release, except: sensitive_repository_info
      end
    ...
    helpers do
      ...
      def sensitive_repository_info
        if can?(current_user, :read_commit_status, user_project)
          []
        else
          [:tag_name, :commit]
        end
