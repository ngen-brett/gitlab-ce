  ...
  class Wikis < Grape::API
    ...
    resource :projects, requirements: WIKI_ENDPOINT_REQUIREMENTS do
      ...
      params do
        ...
        requires 'file.path', type: String, desc: %q(path to locally stored body (generated by Workhorse))
        requires 'file.name', type: String, desc: %q(real filename as send in Content-Disposition (generated by Workhorse))
        requires 'file.size', type: Integer, desc: %q(real size of file (generated by Workhorse))
        requires 'file.md5', type: String, desc: %q(md5 checksum of the file (generated by Workhorse))
        requires 'file.sha1', type: String, desc: %q(sha1 checksum of the file (generated by Workhorse))
        requires 'file.sha256', type: String, desc: %q(sha256 checksum of the file (generated by Workhorse))
        requires 'file.sha512', type: String, desc: %q(sha256 checksum of the file (generated by Workhorse))
      end
