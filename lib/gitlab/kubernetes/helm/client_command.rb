    ...
    module Helm
      module ClientCommand
        ...
        def wait_for_tiller_command
          tls_flags = optional_tls_flags
          tls_str = tls_flags.present? ? ' ' + tls_flags.shelljoin : ''
          ...
          "for i in $(seq 1 30); do helm version#{tls_str} && break; sleep 1s; echo \"Retrying ($i)...\"; done"
        end
