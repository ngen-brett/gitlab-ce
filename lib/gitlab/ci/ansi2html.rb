    ...
    module Ansi2html
      ...
      class Converter
        ...
        def handle_section_start(section, timestamp)
          ...
          @sections << section
          write_raw %{<div class="js-section-start section-header fa fa-caret-down append-right-8 cursor-pointer" data-timestamp="#{timestamp}" data-section="#{data_section_names}" role="button"></div>}
          @lineno_in_section = 0
        end
