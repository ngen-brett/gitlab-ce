        ...
        class Policy < ::Gitlab::Config::Entry::Simplifiable
          ...
          def self.default_only
            if Feature.enable(:ci_new_default_only, project)
              { refs: %w[tags merge_requests], protected_branches: %w[/.+/] }
            else
          ...
          class ComplexPolicy < ::Gitlab::Config::Entry::Node
            ...
            ALLOWED_KEYS = %i[refs kubernetes variables changes protected_branches projects].freeze
            attributes :refs, :kubernetes, :variables, :changes, :protected_branches, :projects
            ...
            validations do
              ...
              with_options allow_nil: true do
                ...
                validates :protected_branches, array_of_strings: true
